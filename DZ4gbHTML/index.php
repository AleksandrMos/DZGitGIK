...
$info = [
    [
        'name' => 'Инженер',
        'dataStarta' => 'Сентябрь 2016',
        'work_descrip' => 'И тут описание долгого и очень тернистого пути инженера',
    ],
    [
        'name' => 'Тестировщик',
        'dataStarta' => 'Сентябрь 2022',
        'work_descrip' => 'Начало нового пути',
    ],
    [
        'name' => 'Плотник',
        'dataStarta' => 'Июнь 2022',
        'work_descrip' => 'Плотник на минималках, сделал свой первый стол из эпоксиднйо смолы!',
    ],
];
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $info[$i]['name']?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $info[$i]['dataStarta']?><span
